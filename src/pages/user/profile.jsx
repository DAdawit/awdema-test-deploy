...
import SellerProfile2 from "@/components/user/SellerProfile";
    ...
    <>
      ...
      <section className="px-10 h-screen">
        ...
        <div className="">
          ...
          <div className="mt-1">
            {user.isSeller ? (
              <Link href="/vendor/addShopeCover" className="mt-1">
                <Button
                  variant="outlined"
                  className="flex justify-center items-center  bg-white text-primary border-2 border-primary px-4 py-2 w-min"
                >
