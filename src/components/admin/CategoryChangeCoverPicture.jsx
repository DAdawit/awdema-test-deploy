...
import { CHANGE_CATEGORY_COVER_PICTURE } from "@/graphql";
export default function CategoriesChangeCoverPicture({
  categoryName,
  refetch,
}) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{`${categoryName}`}</DialogTitle>
        <DialogContent>
