...
import ActiveUsers from "./TotalRevenu";
import WeaklySellingReport from "./WeaklySellingReport";
    ...
    <>
      <div className="container mx-auto px-5">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-evenly gap-5">
          <div className="grid bg-indigo-500 px-5  py-3 text-white rounded-xl w-full">
          ...
          <div className="grid bg-sky-600 px-5  py-3 text-white rounded-xl w-full">
            <div className="flex gap-2 ">
              <span className="block hover:scale-110">
                <IconShopProduct />
              </span>
          ...
          <div className="grid bg-pink-600 px-5  py-3 text-white rounded-xl w-full">
            <div className="flex gap-2 ">
              <span className="block hover:scale-110">
                <IconBasket />
              </span>
      ...
      <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-3 md:gap-2 lg:gap-16 mt-10">
        ...
        <div className="grid grid-cols-1  mt-10 shadow-lg w-full rounded-lg">
          <h1 className="mb-3 px-5 mt-3 text-gray-800 font-medium">Orders</h1>
          <h1 className="text-gray-600 px-5 text-sm">
      ...
      <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-3 mt-10 gap-5">
        <div className="grid grid-cols-1 md:col-span-2 shadow-lg">
          <h3 className="px-5 font-medium text-gray-800 mt-3">Active users</h3>
          <p className="px-5 text-sm mt-3 text-gray-600">
            Total Active users the of past 12 Months
          </p>
      ...
      <div className="container mx-auto px-5 grid grid-cols-1 md:grid-cols-3 mt-10 gap-5">
        <div className="col-span-1 md:col-span-2 shadow-lg">
          <WeaklySellingReport />
      ...
      <div className="container mx-auto px-5 grid-cols-5 mt-10 gap-5">
